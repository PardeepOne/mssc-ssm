...
public class StateMachineConfig extends StateMachineConfigurerAdapter<PaymentState, PaymentEvent> {
    @Override
    public void configure(StateMachineModelConfigurer<PaymentState, PaymentEvent> model) throws Exception {
    ...
    public void configure(StateMachineConfigurationConfigurer<PaymentState, PaymentEvent> config) throws Exception {
        StateMachineListenerAdapter<PaymentState, PaymentEvent> adapter = new StateMachineListenerAdapter<>() {
            ...
            public void stateChanged(State<PaymentState, PaymentEvent> from, State<PaymentState, PaymentEvent> to) {
                log.info(String.format("stateChanged(\n\tfrom: %s, \n\tto: %s", from, to));
            }
        };
    ...
    public Action<PaymentState, PaymentEvent> authorizeAction() {
        return context -> {
            ...
            if (new Random().nextInt(10) < 9) {
                System.out.println("Auth is approved!");
                ...
                System.out.println("Auth is declined!");
                context
                        .getStateMachine()
                        .sendEvent(
                                MessageBuilder.withPayload(
